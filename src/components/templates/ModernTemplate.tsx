...
export const ModernTemplate: React.FC<ModernTemplateProps> = ({ invoice, logoSrc, currency = 'USD' }) => {
    ...
    <div className="bg-white rounded-xl shadow-lg overflow-hidden w-full max-w-4xl mx-auto">
      ...
      <div className="bg-gradient-to-r from-slate-800 to-slate-600 p-6 text-white">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-slate-200">{invoice.from.address}</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-6">
        <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-lg">
          ...
          <p className="text-slate-900 font-bold mt-1">{formatDate(invoice.date)}</p>
        </div>
        <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-lg">
          <div className="flex items-center">
          ...
          <p className="text-slate-900 font-bold mt-1">{formatDate(invoice.dueDate)}</p>
        </div>
        <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-lg">
          <div className="flex items-center">
          ...
          <p className="text-slate-900 font-bold mt-1 capitalize">{invoice.paymentType}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-6 pb-6">
        <div className="bg-gradient-to-br from-slate-50 to-gray-50 p-4 rounded-lg border border-slate-200">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-bold text-slate-700 uppercase tracking-wider text-xs">From</h3>
          </div>
        ...
        <div className="bg-gradient-to-br from-gray-50 to-slate-50 p-4 rounded-lg border border-gray-200">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-bold text-slate-700 uppercase tracking-wider text-xs">Billed To</h3>
          </div>
          ...
          <table className="w-full">
            ...
            <tbody>
              {invoice.items.map((item) => (
                <tr key={item.id} className="border-b border-slate-100 last:border-b-0 hover:bg-gray-50">
      ...
      {/* Summary */}
      <div className="px-6 pb-6">
        <div className="bg-gradient-to-br from-slate-50 via-gray-50 to-blue-50 p-4 rounded-xl border border-slate-200">
